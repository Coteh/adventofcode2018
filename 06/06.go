...
func buildBoard(coords []Coord, maxDesiredDistance int) *Board {
...
func main() {
	...
	maxDesiredDistance := flag.Int("max-desired-distance", 10000, "Max desired Manhattan distance (for part 2)")
	flag.Parse()
	...
	if *debugFlag {
		...
		fmt.Println("maxDesiredDistance", *maxDesiredDistance)
	}

	board := buildBoard(coords, *maxDesiredDistance)
